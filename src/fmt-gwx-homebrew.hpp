...
#ifndef _CAMOTO_FMT_GWX_HOMEBREW_HPP_
#define _CAMOTO_FMT_GWX_HOMEBREW_HPP_
...
/// HomeBrew .GW[123] format handler.
class ArchiveType_GWx_HomeBrew: virtual public ArchiveType
{
	public:
		ArchiveType_GWx_HomeBrew();
		virtual ~ArchiveType_GWx_HomeBrew();
...
/// HomeBrew .GW[123] archive instance.
class Archive_GWx_HomeBrew: virtual public Archive_FAT
{
	public:
		Archive_GWx_HomeBrew(std::unique_ptr<stream::inout> content);
		virtual ~Archive_GWx_HomeBrew();
...
#endif // _CAMOTO_FMT_GWX_HOMEBREW_HPP_
