...
#ifndef _CAMOTO_FMT_DAT_LOSTVIKINGS_HPP_
#define _CAMOTO_FMT_DAT_LOSTVIKINGS_HPP_
...
class Archive_DAT_LostVikings: virtual public Archive_FAT
{
	public:
...
#endif // _CAMOTO_FMT_DAT_LOSTVIKINGS_HPP_
