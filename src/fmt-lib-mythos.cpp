	...
	std::unique_ptr<stream::inout> content, SuppData& suppData) const
{
	...
	return std::make_shared<Archive_LIB_Mythos>(std::move(content));
}

std::shared_ptr<Archive> ArchiveType_LIB_Mythos::open(
	std::unique_ptr<stream::inout> content, SuppData& suppData) const
{
	return std::make_shared<Archive_LIB_Mythos>(std::move(content));
}
...
Archive_LIB_Mythos::Archive_LIB_Mythos(std::unique_ptr<stream::inout> content)
	:	Archive_FAT(std::move(content), LIB_FIRST_FILE_OFFSET, LIB_MAX_FILENAME_LEN)
{
