...
FixedArchiveFile ccaves_file_list[] = {
	...
	{0x8CE0 + MAPSIZE + LEVELSIZE * 2,  LEVELSIZE, "e1l03.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 3,  LEVELSIZE, "e1l04.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 4,  LEVELSIZE, "e1l05.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 5,  LEVELSIZE, "e1l06.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 6,  SMLEVEL,   "e1l07.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 6 + SMLEVEL, SMLEVEL, "e1l08.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 6 + SMLEVEL*2, LEVELSIZE, "e1l09.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 7 + SMLEVEL*2, LEVELSIZE, "e1l10.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 8 + SMLEVEL*2, LEVELSIZE, "e1l11.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 9 + SMLEVEL*2, LEVELSIZE, "e1l12.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 10 + SMLEVEL*2, LEVELSIZE, "e1l13.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 11 + SMLEVEL*2, SMLEVEL, "e1l14.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 11 + SMLEVEL*3, LEVELSIZE, "e1l15.ccl"},
	{0x8CE0 + MAPSIZE + LEVELSIZE * 12 + SMLEVEL*3, LEVELSIZE, "e1l16.ccl"},
};
...
ArchivePtr EXE_CCavesType::newArchive(iostream_sptr psArchive, MP_SUPPDATA& suppData) const
	throw (std::ios::failure)
{
...
ArchivePtr EXE_CCavesType::open(iostream_sptr psArchive, MP_SUPPDATA& suppData) const
	throw (std::ios::failure)
{
	return ArchivePtr(new EXE_CCavesArchive(psArchive));
}

MP_SUPPLIST EXE_CCavesType::getRequiredSupps(const std::string& filenameArchive) const
	throw ()
{
